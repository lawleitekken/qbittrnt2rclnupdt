...
* Click on the Rapid deployment button [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/lawleitekken/qbittrnt2rclnupdt/tree/fix-folder-upload-issue) and deploy app
